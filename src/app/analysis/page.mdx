...
# Test steps analysis
Analyze and continuously improve your test steps. {{ className: 'lead' }}
...
It's also helpful to get an overview across all executed runs, which you can access on the Procedure page. This page provides key indicators in various tabs (e.g., Cpk, yields). Learn more in the [FPY and Cpk](/analysis) section.
