...
<Note>
  Click on a test phase in the **Phases** table to go to the Procedure page, where data is sorted by that specific phase.
</Note>
...
<Note>
  Click on a phase (e.g., "thermal_reading" or "motor_noise") to filter by it. To clear the filter, select **Clear Filter**.
</Note>


### Phases by failure and Step by duration
