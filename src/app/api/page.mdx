...
<Row>
  ...
  <Col>
    ...
    <Properties>
      ...
      <Property name="outcome" type="boolean, required" indent={1}>
        Indicates if the phase passed or failed.
      </Property>
      <Property name="started_at" type="string, required" indent={1}>
        ISO 8601 start time of the phase. _Example: "2024-09-11T08:00:00Z"_
      </Property>
      <Property name="duration" type="string, required" indent={1}>
      ...
      <Property name="measurements" type="array, optional" indent={1}>
        ...
        <Property name="outcome" type="boolean, required" indent={2}>
          Indicate if the measurement is passed/failed.
        </Property>
        <Property name="value" type="float, required" indent={2}>
          The value of the measurement.
        </Property>
        <Property name="units" type="float, optional" indent={2}>
        The units of the value. _Examples: Celsius Degrees, Voltage_
        </Property>
        <Property name="lower_limit" type="float, optional" indent={2}>
          Minimum threshold. _Example: 3.2V_
        </Property>
        <Property name="upper_limit" type="float, optional" indent={2}>
          Maximum threshold. _Example: 13.2V_
        </Property>
