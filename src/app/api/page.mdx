...
<Row>
  ...
  <Col>
    ...
    <Properties>
      ...
      <Property name="part_name" type="string, optional" indent>
      ...
      <Property name="outcome" type="boolean, required" indent>
        Indicates if the phase passed. _Example: true_
      </Property>
      ...
      <Property name="measurements" type="array, optional" indent>
        The array of one or several measurement in one phase.
      </Property>
        <Property name="name" type="string, required" indent>
          The name of one measurement.
        </Property>
        <Property name="outcome" type="string, required" indent>
          The outcome of the measurement. _Examples: "PASS", "FAIL", "STOP", "ERROR"_
        </Property>
        <Property name="value" type="float, required" indent>
          The value of the measurement.
        </Property>
        <Property name="units" type="float, optional" indent>
        The units of the value. _Examples: Celsius Degrees, Voltage_
        </Property>
        <Property name="lower_limit" type="float, optional" indent>
          Minimum threshold. _Example: 3.2V_
        </Property>
        <Property name="upper_limit" type="float, optional" indent>
