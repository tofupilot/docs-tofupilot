...
## Integration
You can upload test results anytime, specifying `started_at` to keep the original test date; otherwise, the upload date will apply. Use `create_run` to add test details or attachments with the TofuPilot Python Client, or `create_report_from_openhtf_record` to upload your OpenHTF JSON record to TofuPilot.
