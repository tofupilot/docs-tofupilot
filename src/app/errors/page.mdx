...
<Note>
  ...
  your code before contacting TofuPilot support.
</Note>
...
<Row>
  <Col>
    ...
    Whenever a request is unsuccessful, the TofuPilot API will return an error response with an error type and message. You can use this information to understand better what has gone wrong and how to fix it. Most of the error messages are pretty helpful and actionable.
