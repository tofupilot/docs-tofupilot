...
This guide will help your upload your first test run using TofuPilot Python SDK. {{ className: 'lead' }}
...
If you haven't downloaded it yet, install our python SDK:
...
A new run was created from the procedure FVT1 and associated with Unit ‘EXAMPLE-ID’ derived from Component ‘EXAMPLE-SN’. As the Unit and Component did not previously exist, they were automatically created. Since the test_function returned True, the run was assigned a ‘Passed’ (green) status. The run duration was calculated based on the execution time of the test_function.
