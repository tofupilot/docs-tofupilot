...
Uploading your first Run to TofuPilot is quick and easy using the Python client. This guide will show you how in just 2 minutes. {{ className: 'lead' }}
...
A Run can now be easily created using a few parameters. Here is the code snippet:
