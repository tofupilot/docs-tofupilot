...
<CodeGroup>
  <File
    title="OpenHTF"
    branch="main"
    path="docs/openhtf/phases/phases-required/main.py"
  />

  <File
    title="Python"
    branch="main"
    path="docs/client/phases/phases-required/main.py"
  />
</CodeGroup>
...
<CodeGroup>
  <File
    title="OpenHTF"
    branch="main"
    path="docs/openhtf/phases/phases-optional/main.py"
  />

  <File
    title="Python"
    branch="main"
    path="docs/client/phases/phases-optional/main.py"
  />
</CodeGroup>
...
<CodeGroup>
  <File
    title="OpenHTF"
    branch="main"
    path="docs/openhtf/phases/phases-advanced/main.py"
  />

  <File
    title="Python"
    branch="main"
    path="docs/client/phases/phases-advanced/main.py"
  />
</CodeGroup>
