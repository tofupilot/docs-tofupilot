    ...
    client.create_run(
            ...
            phases=[
                # Phase without measurement
                {
                    ...
                    "outcome": PhaseOutcome.PASS,
                    "start_time_millis": start_time_millis,
                    "end_time_millis": start_time_millis + 3000 # phase duration of 3 seconds
                },
                # Phase with measurement
                {
                    ...
                    "end_time_millis": start_time_millis + 6000, # phase duration of 3 seconds
                    "measurements": [
                        {
                ...
                # Phase with multiple measurements
                {
                    ...
                    "end_time_millis": start_time_millis + 19000, # phase duration of 10 seconds
                    "measurements": [
                        {
                            "name": "input_voltage",
                            "outcome": MeasurementOutcome.PASS,
