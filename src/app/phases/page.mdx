...
def main():
    ...
    client.create_run(
        ...
        phases=phases,
        run_passed=all(phase["outcome"] for phase in phases),
    )
...
<Properties>
  ...
  <Property name="outcome" type="boolean">
    Pass/Fail outcome of the phase.
  </Property>
...
# Phase returns a Pass status due to measurement (3.3) within defined limits [3.1, 3.5]
