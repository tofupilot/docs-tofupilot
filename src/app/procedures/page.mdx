...
export const metadata = {
  ...
  description:
    'Learn how to manage serial numbers, sub-units, and traceability for test procedures in TofuPilot.',
  keywords: [
    ...defaultKeywords,
    'Unit Under Test',
    'UUT',
  ...
  openGraph: {
    ...defaultOpenGraph,
    title:
      'Unit Under Test (UUT) - Serial Number Management & Traceability | TofuPilot Documentation',
    description:
      'This guide explains how to use TofuPilot’s sub-units feature to track and manage UUTs across test procedures.',
    images: [
      {
        url: 'https://tofupilot.com/docs/procedure-header.png',
        width: 800,
        height: 600,
        alt: 'Unit Under Test (UUT) header showing serial number tracking in TofuPilot.',
      },
    ],
  },
}
