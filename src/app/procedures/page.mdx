...
Les informations concernant le rapport de test se trouve dans une section à part: Report.

AJOUTER - un exemple avec les paramètres optionnels comme dans steps
