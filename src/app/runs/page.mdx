  ...
  <Col>
    ...
    <Properties>
      ...
      <Property name="steps" type="array(record)">
        ...
        - step_passed (boolean): A boolean indicating whether the step passed or failed.
        - started_at (string / datetime): An ISO 8601 formatted timestamp (or datetime in Python) indicating the start time of the step.
        - duration (string): An ISO 8601 duration string indicating the duration of the step.
        - measurement_unit (optional, string): The unit in which the measured value was measured.
        - measurement_value (optional, float): The value measured during the step execution.
        - limit_low (optional, float): The minimum acceptable threshold for the step value.
        - limit_high (optional, float): The maximum acceptable threshold for the step value.
      </Property>
