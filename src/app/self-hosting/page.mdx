...
2. Install Git, Docker and Docker-Compose (Debian/Ubuntu based Distro example)
...
3. Clone the [installation repository](https://github.com/tofupilot/self-hosting) provided by our team.

   ```bash
   git clone https://github.com/tofupilot/self-hosting.git
   ```
...
5. Locate and replace the following lines:
