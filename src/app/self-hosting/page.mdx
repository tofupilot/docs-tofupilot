...
For strict IT policies or specific connectivity needs, TofuPilot can be self-hosted.

## Prerequisites

### Enterprise trial

Contact [our team](mailto:support@tofupilot.com) to sign up for an **Enterprise** plan trial. We will grant you access to the private self-hosting installation repository along with the TofuPilot docker image.
...
4. Connect to your Github account to pull TofuPilot's Image
