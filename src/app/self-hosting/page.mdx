...
2. **Domain Name**: A domain / sub-domain name that you will use for your self-hosted TofuPilot application (e.g., tofupilot.yourcompany.com).
3. **Domain Name**: A domain / sub-domain name that you will use for the object storage of your self-hosted TofuPilot application (defaults to storage.DOMAIN_NAME).
...
SET BASE_URL WHEN USING PYTHON CLIENT
