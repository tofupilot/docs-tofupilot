...
TofuPilot allows you to log steps of your run by adding the `steps` parameter. Below is a code snippet demonstrating how to create a Run with steps:
...
You can access the steps of a Run in the ‘Steps’ section of the Run page.

<Image src={'/test-steps-run.png'} alt={'Steps of the run'} />

## View the Procedure Page

The Procedure page offers a detailed summary of all steps from each Run executed as part of the Procedure.
