export const metadata = {
  title: 'Steps',
  description:
    'Tofupilot provides a simple way to upload and manage files generated during manufacturing tests, such as logs, pictures, and PDFs, with detailed views available on the web platform.',
}

# Steps

Hardware manufacturing tests often involve multiple steps such as connections, measurements, calibration, and more. Tofupilot offers a simple yet comprehensive way to record the details of these steps and analyze their performance across all executions. {{ className: 'lead' }}
...
Each `step` in the `steps` array provided to `create_run` can include the following parameters:
