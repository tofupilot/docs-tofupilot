...
## In-app view
You can see the creation of the camera assembly with its sub-units listed as childer in the **Units** page. You can navigate to these sub-units using the expansion menu on the left.
