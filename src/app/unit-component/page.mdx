...
le suivi des pièces par numéro de série et part number est essentielle pour tout manufacturing test 

tofupilot gère automatiquement la création et la gestion des unités par numéro de série et les rattache à la révision de composant de référence pour que vous ayez une traçabilité précise et rapide de chaque pièce testée

il faut toujours spécifier un numéro de série + la part number

si la pièce n'est pas créé elle sera crée automatiquement

si le composant n'existe pas, cela va le créér également

page unit 

page composants

si besoin les numéros de série pour les unités et les serial number peuvent être modifiés depuis la page unit et composants

revisions

la gestion des révisions est créée par défaut, la révision A

si vous spécifiez une révision en plus pour le composant cela va la créér automatiquement

thumbnails

pour faciliter la lecture vous pouvez ajouter un thumnail à un type de component et elle apparaitra pour
