...
You can rename a Component's name, `part_number`, or `revision` directly in the application. Go to the Component page, then select **Edit name**, **Edit revision**, or **Edit part number** from the menu.
